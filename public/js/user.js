...
//             quantity: product.stock,
//             thumbnail: product.thumbnail,
//             isLiked: false // Initialize as false, will be updated by checkLikedProducts
//         }));
...
//     await fetchProductsFromApi(30, 0);
//     await checkLikedProducts();
//     showLikedProduct.innerHTML = `Show Liked Products <i class="fa-solid fa-heart">`;
//     renderItems();
// }
...
//                 } else {
//                     item.isLiked = false;
//                     // If we're showing liked products, remove this item from view
//                     if (showingLikedProducts) {
//                         items = items.filter(i => i.id !== item.id);
//                         renderItems();
//                     }
